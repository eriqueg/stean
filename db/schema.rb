...
ActiveRecord::Schema.define(version: 2019_03_23_011459) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "b_ibliotecas", force: :cascade do |t|
    t.bigint "usuario_id"
    t.bigint "jogo_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["jogo_id"], name: "index_b_ibliotecas_on_jogo_id"
    t.index ["usuario_id"], name: "index_b_ibliotecas_on_usuario_id"
  end
  ...
  add_foreign_key "b_ibliotecas", "jogos"
  add_foreign_key "b_ibliotecas", "usuarios"
